...
class CostTracker:
    ...
    def __init__(self, config_path: str = "config/settings.yaml"):
        ...
        baseline_config = config['baseline_comparison']
        self.baseline_model = baseline_config['baseline_model']
        self.baseline_cost_per_million = baseline_config['baseline_cost_per_million']
        self.baseline_tokens_per_request = baseline_config['tokens_per_request']
    ...
    def _calculate_savings(self, records: List[APICallRecord], total_reviews: int) -> Dict[str, float]:
        ...
        # Estimate baseline cost using configured values
        baseline_total_tokens = total_reviews * self.baseline_tokens_per_request
